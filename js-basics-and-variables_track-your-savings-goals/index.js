...
2. Calculate the total savings after the specified number of months by using the formula `startingBalance + (monthlyContribution * months)`, and store the result in a variable called `v`.
...
let totalSavings = numMonths * monthlyContribution;
let v = startingBalance + totalSavings;
