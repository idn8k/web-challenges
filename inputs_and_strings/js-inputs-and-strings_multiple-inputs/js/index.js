...
copyButton.addEventListener('click', () => {
   const value1 = firstCopyInput.value;
   secondCopyInput.value = value1;
});
...
copyInUppercaseButton.addEventListener('click', () => {
   const value1 = firstCopyInUppercaseInput.value;
   secondCopyInUppercaseInput.value = value1.toUpperCase();
});
...
switchValueButton.addEventListener('click', () => {
   const val1 = firstSwitchValueInput.value;
   const val2 = secondSwitchValueInput.value;

   firstSwitchValueInput.value = val2;
   secondSwitchValueInput.value = val1;
});
